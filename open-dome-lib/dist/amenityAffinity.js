...
exports.SLOT_TAGS = void 0;
exports.analyzeEventProfile = analyzeEventProfile;
exports.analyzeUserIntent = analyzeUserIntent;
exports.formatAffinityInsight = formatAffinityInsight;
exports.pickRelatedAmenity = pickRelatedAmenity;
exports.rankAmenitiesForSlot = rankAmenitiesForSlot;
exports.scoreAmenity = scoreAmenity;
var _amenities = _interopRequireDefault(require("./dbs/amenities.json"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
const SLOT_TAGS = exports.SLOT_TAGS = {
 ...
 */
function analyzeEventProfile(event) {
 ...
 * Higher = more related.
 */
function scoreAmenity(amenity, slot, {
  eventProfile,
  userIntent,
  userText
} = {}) {
 ...
 */
function rankAmenitiesForSlot(slot, usedIds, options = {}) {
  const {
    eventProfile,
    userIntent,
    userText,
  ...
  const candidates = _amenities.default.filter(a => {
 ...
 */
function pickRelatedAmenity(slot, usedIds, options = {}) {
 ...
 */
function formatAffinityInsight(eventProfile, userIntent, stops) {
  const bits = [];
