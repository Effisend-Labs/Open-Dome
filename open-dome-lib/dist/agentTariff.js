...
exports.GEMINI_CHAT_MODELS = void 0;
exports.formatTariffForX402 = formatTariffForX402;
exports.formatTariffLabel = formatTariffLabel;
exports.quotePromptTariff = quotePromptTariff;
exports.resolveGeminiChatModel = resolveGeminiChatModel;
/**
...
const GEMINI_CHAT_MODELS = exports.GEMINI_CHAT_MODELS = [{
  id: 'fast-lite',
...
function resolveGeminiChatModel(modelId) {
...
function formatTariffForX402(totalUsd) {
...
function formatTariffLabel(totalUsd) {
  const n = roundUsd(totalUsd);
 ...
 */
function quotePromptTariff(text, modelId) {
