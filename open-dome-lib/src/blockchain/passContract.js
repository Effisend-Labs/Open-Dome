...
export const OPENDOME_PASS_NETWORK = 'base';
...
export const OPENDOME_PASS_ABI = [
  ...
  'function scanPassBatch(address[] accounts, uint256[] ids, uint256[] amounts) external',
  'function balanceOf(address account, uint256 id) view returns (uint256)',
  'function uri(uint256 id) view returns (string)',
  'function hasRole(bytes32 role, address account) view returns (bool)',
  'function EVENT_MANAGER_ROLE() view returns (bytes32)',
  'function SCANNER_ROLE() view returns (bytes32)',
];

/** Map used by Wallet / host for getAllNFTs */
export const OPENDOME_PASSES_CONFIG = {
