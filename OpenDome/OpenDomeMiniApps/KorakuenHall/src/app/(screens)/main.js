...
const UPCOMING_EVENTS = [
  { id: '1', title: 'Heavyweight Bout', artist: 'BOXING NIGHT', date: 'NOV 05', image: 'https://images.unsplash.com/photo-1509563268479-0f004cf3f58b?q=80&w=1000' },
  { id: '2', title: 'Martial Arts', artist: 'MMA FINALS', date: 'DEC 10', image: 'https://images.unsplash.com/photo-1555597673-b21d5c935865?q=80&w=1000' },
];

export default function KorakuenHallApp() {
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
        ...
        <View style={styles.heroWrapper}>
          <ImageBackground 
            source={{ uri: 'https://images.unsplash.com/photo-1599839619722-39751411ea63?q=80&w=1000' }} 
            style={styles.heroBg}
          >
            <LinearGradient 
            ...
            >
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroHeadline}>WRESTLING\nNOAH</Text>
                <Text style={styles.heroSub}>TODAY • MATCH 18:30</Text>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>UPCOMING AT KORAKUEN HALL</Text>
          <FlatList
            horizontal
