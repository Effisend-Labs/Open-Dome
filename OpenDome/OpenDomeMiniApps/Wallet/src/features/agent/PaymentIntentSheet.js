    ...
    >
      ...
      >
        ...
        <View style={[styles.metaRow, { borderColor: tokens.BORDER }]}>
          ...
          <Text
            style={[styles.metaValue, { color: tokens.FG, fontFamily: tokens.font.mono }]}
            numberOfLines={1}
          >
            {targetLabel}
          </Text>
        ...
        >
          <Text
            style={[styles.selectText, { color: tokens.FG, fontFamily: tokens.font.primary }]}
          >
            {selectedNetwork}
          </Text>
        ...
        {open ? (
          ...
          >
            <ScrollView nestedScrollEnabled style={{ maxHeight: 168 }} showsVerticalScrollIndicator={false}>
