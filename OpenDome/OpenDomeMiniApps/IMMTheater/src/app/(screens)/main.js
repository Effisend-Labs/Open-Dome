...
const UPCOMING_EVENTS = [
  { id: '1', title: 'Symphony Orchestra', artist: 'MOZART NIGHT', date: 'SEP 20', image: 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?q=80&w=1000' },
  { id: '2', title: 'The Phantom', artist: 'BROADWAY', date: 'OCT 12', image: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?q=80&w=1000' },
];

export default function IMMTheaterApp() {
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
        ...
        <View style={styles.heroWrapper}>
          <ImageBackground 
            source={{ uri: 'https://images.unsplash.com/photo-1507676184212-d0330a15233c?q=80&w=1000' }} 
            style={styles.heroBg}
          >
            <LinearGradient 
            ...
            >
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroHeadline}>HAMILTON\nLIVE</Text>
                <Text style={styles.heroSub}>TONIGHT • SHOW 19:30</Text>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>UPCOMING AT IMM THEATER</Text>
          <FlatList
            horizontal
