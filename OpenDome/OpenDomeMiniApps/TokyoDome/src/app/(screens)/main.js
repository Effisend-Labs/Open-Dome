...
const UPCOMING_EVENTS = [
  { id: '1', title: 'Global Pop World Tour', artist: 'THE WEEKND', date: 'SEP 14', image: 'https://images.unsplash.com/photo-1540039155732-6847350057c5?q=80&w=1000' },
  { id: '2', title: 'Championship Finals', artist: 'GIANTS VS TIGERS', date: 'OCT 02', image: 'https://images.unsplash.com/photo-1508344928928-7137b29de216?q=80&w=1000' },
];

export default function TokyoDomeApp() {
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
        ...
        <View style={styles.heroWrapper}>
          <ImageBackground 
            source={{ uri: 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?q=80&w=1000' }} 
            style={styles.heroBg}
          >
            <LinearGradient 
            ...
            >
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroHeadline}>EDM FUSION\nFESTIVAL</Text>
                <Text style={styles.heroSub}>TONIGHT • DOORS 19:00</Text>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>UPCOMING AT TOKYO DOME</Text>
          <FlatList
            horizontal
